...
struct Topic {
    ...
    uint16 topicFundFeePercentage; // percentage of a vote given to the topic
    bool allowChoiceFunds; // percentage of a vote given to the choice
    ...
    bool hasExternalFunding; // if topic supports external funding for it's choices
}
